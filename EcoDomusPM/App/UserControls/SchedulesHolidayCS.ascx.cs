...
public partial class App_UserControls_SchedulesHolidayCS : System.Web.UI.UserControl
{
    ...
    private void Update_Flag_For_Schedules(EnergyPlusModel obj_energy_plus_model)
    {
        ...
        try
        {
            ...
            obj_energy_plus_model.Col_name = "holiday";
