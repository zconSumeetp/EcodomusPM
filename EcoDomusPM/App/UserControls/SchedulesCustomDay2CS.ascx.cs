...
public partial class App_UserControls_SchedulesCustomDay2CS : System.Web.UI.UserControl
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Page.IsValid)
            {
                ...
                {
                    custom_day_2.Value = "chkCustomDay2";
                }
            }
    ...
    private void Update_Flag_For_Schedules(EnergyPlusModel obj_energy_plus_model)
    {
        ...
        try
        {
            ...
            obj_energy_plus_model.Col_name = "custom_day_2";
