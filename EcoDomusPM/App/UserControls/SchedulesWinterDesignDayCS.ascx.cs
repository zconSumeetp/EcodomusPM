...
public partial class App_UserControls_SchedulesWinterDesign_DayCS : System.Web.UI.UserControl
{
                    ...
                    if (rcbScheduleName != null)
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                            {
                                ...
                                if (tab_name.Equals("WinterDesignDay"))
                                {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (winter_design_day != null)
                {
                    winter_design_day.Value = "chkWinterDesignDay";
                }
    ...
    private void Update_Flag_For_Schedules(EnergyPlusModel obj_energy_plus_model)
    {
        ...
        try
        {
            ...
            obj_energy_plus_model.Col_name = "winter_design_day";
