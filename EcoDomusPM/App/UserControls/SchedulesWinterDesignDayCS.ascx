<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SchedulesWinterDesignDayCS.ascx.cs" Inherits="App_UserControls_SchedulesWinterDesign_DayCS" %>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <%--<asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Save" Width="50px"
                                    ...
                                    <telerik:RadButton runat="server" ID="btnSave" OnClick="btnSave_Click" Text="Save"
                                    OnClientClicked="ValidateFields" AutoPostBack="false" Style="top: 0px; left: -56px">
                                </telerik:RadButton>
                            </td>
                            <td>
                            </td>
