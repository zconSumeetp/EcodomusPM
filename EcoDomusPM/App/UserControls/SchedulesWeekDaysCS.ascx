<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SchedulesWeekDaysCS.ascx.cs"
    Inherits="App_UserControls_SchedulesWeekDays" %>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table border="0" align="left">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkWeekDays" runat="server" CssClass="normalLabel" Text="Week Days" TextAlign="Right" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
