<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EnergyModelingSimulationOutput.ascx.cs" Inherits="App_UserControls_UserControlNewUI_EnergyModelingSimulationOutput" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script language="javascript" type="text/javascript">
        ...
        function preserverowsselected() {
            var grids = document.getElementsByClassName("<%=rg_simulation_output.ClientID %>");
            var MasterTable = document.getElementById("<%=rg_simulation_output.ClientID %>");
...
<telerik:RadFormDecorator ID="rdfTaskEquipment" runat="server" Skin="Default" 
    DecoratedControls="Buttons, Scrollbars, Textbox, Textarea, Label" />
    ...
    <tr>
        <td style="border-top-color: transparent; border-top-width: 0px;">
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;
                ...
                <tr>
                    <td style="padding-left: 15px; height: 57px; border-color: transparent; border-width: 0px">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td style="background-image: url('../Images/asset_container_3.png'); height: 40px;
                                                width: 200px; background-repeat: no-repeat" align="center">
                                                <asp:Label ID="lbl_list" runat="server" Text="Simulation Output" Font-Size="10" ForeColor="Red"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="50%">
                                        <tr>
                                            <td style="padding-bottom: 3px">
                                                <asp:Label ID="lbl_schedule_type" runat="server" Text="Select Simulation Output Type"
                                                    CssClass="normalLabel"></asp:Label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 2px">
                                                <telerik:RadComboBox ID="cmb_simulation_output_type" runat="server" Height="150"
                                                    Width="225" ExpandDirection="Down" Skin="Default" AutoPostBack="true" OnSelectedIndexChanged="cmb_simulation_output_type_SelectedIndexChanged">
                                                </telerik:RadComboBox>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse">
                            ...
                            <tr style="background-color: Gray;">
                                <td style="height: 30px; padding-left: 15px">
                                    <asp:Label ID="Label1" runat="server" Text="SIMULATION OUTPUT" CssClass="normalLabel"
                ...
                <tr>
                    <td>
                        <telerik:RadGrid ID="rg_simulation_output" runat="server" BorderWidth="1px" CellPadding="0"
                            ...
                            OnItemDataBound="rg_simulation_output_ItemDataBound" OnPageSizeChanged="rg_simulation_output_PageSizeChanged"
                            OnItemCommand="rg_simulation_output_ItemCommand" OnPageIndexChanged="rg_simulation_output_PageIndexChanged"
                            OnSortCommand="rg_simulation_output_SortCommand" OnItemCreated="rg_simulation_output_ItemCreated"
                            OnDataBound="rg_simulation_output_DataBound">
                            <PagerStyle Mode="NextPrevNumericAndAdvanced"/>
                            <ClientSettings>
                                <Selecting AllowRowSelect="true" />
                            </ClientSettings>
                            <MasterTableView EditMode="EditForms" DataKeyNames="attribute_id,fk_field_id,object_id,header_text"
                                CellPadding="0" CellSpacing="0" GroupHeaderItemStyle-HorizontalAlign="Left" GroupHeaderItemStyle-BackColor="#D9D9D9"
                                TableLayout="Fixed" ClientDataKeyNames="attribute_id,fk_field_id,object_id,header_text"
                ...
                <tr>
                    <td>
                        ...
                        <telerik:RadButton ID="btn_delete" runat="server" Text="Delete Object" OnClick="btn_delete_Click"
...
<telerik:RadAjaxManagerProxy runat="server" ID="RadAjaxManagerProxy1">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="rg_simulation_output">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rg_simulation_output" LoadingPanelID="RadAjaxLoadingPanel1" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="cmb_simulation_output_type">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="rg_simulation_output" LoadingPanelID="RadAjaxLoadingPanel1" />
            </UpdatedControls>
        </telerik:AjaxSetting>
