...
public partial class App_UserControls_UserControlNewUI_EnergyModelingSimulationOutput : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (SessionController.Users_.UserId != null)
        {
            if (!Page.IsPostBack)
            {
                if (SessionController.Users_.UserId != null)
                {
                    BindSimulationOutputTypeDropDown();
                    if (cmb_simulation_output_type.Items.Count > 0)
                    {
                        cmb_simulation_output_type.SelectedValue = "Output:SQLite";
                    }

                    BindEnergyModelingSimulationOutputGrid();
                    rg_simulation_output.MasterTableView.GroupsDefaultExpanded = false;
                    if (this.rg_simulation_output.MasterTableView.GroupByExpressions.Count > 0)
                    {
                        //refresh on RreRender if grid not rebound
                        this.rg_simulation_output.MasterTableView.SetLevelRequiresBinding();
                    }
    ...
    private void BindSimulationOutputTypeDropDown()
    {
        ...
        try
        {
            obj_energy_plus_model.Modeling_class_name = "Output Reporting";
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    cmb_simulation_output_type.DataSource = ds;
                    cmb_simulation_output_type.DataTextField = "object_name";
                    cmb_simulation_output_type.DataValueField = "object_name";
                    cmb_simulation_output_type.DataBind();
                }
            }
        }
        catch (Exception ex)
    ...
    private void BindEnergyModelingSimulationOutputGrid()
    {
        EnergyPlusClient obj_energy_plus_client = new EnergyPlusClient();
        EnergyPlusModel obj_energy_plus_model = new EnergyPlusModel();
        DataSet ds = new DataSet();
        try
        {
            if (SessionController.Users_.Em_facility_id != null)
            {
                ...
                if (cmb_simulation_output_type.Items.Count > 0)
                {
                    obj_energy_plus_model.Object_name = cmb_simulation_output_type.SelectedItem.Value;
                ...
                if (ds.Tables.Count > 0)
                {
                    rg_simulation_output.DataSource = ds;
                    rg_simulation_output.DataBind();
                }
                else
                {
                    rg_simulation_output.DataSource = string.Empty;
                    rg_simulation_output.DataBind();
                }
            }
            else
    ...
    protected void rg_simulation_output_ItemCommand(object sender, GridCommandEventArgs e)
    {
        EnergyPlusClient obj_energy_plus_client = new EnergyPlusClient();
        ...
        try
        {
            ...
            rg_simulation_output.MasterTableView.GroupsDefaultExpanded = true;
            if (this.rg_simulation_output.MasterTableView.GroupByExpressions.Count > 0)
            {
                //refresh on RreRender if grid not rebound
                this.rg_simulation_output.MasterTableView.SetLevelRequiresBinding();
    ...
    protected void rg_simulation_output_PageIndexChanged(object sender, GridPageChangedEventArgs e)
    {
        try
        {
            GetSelectedRows();
    ...
    protected void rg_simulation_output_PageSizeChanged(object sender, GridPageSizeChangedEventArgs e)
    {
        try
        {
            GetSelectedRows();
    ...
    protected void rg_simulation_output_SortCommand(object sender, GridSortCommandEventArgs e)
    {
        try
        {
            //GetSelectedRows();
    ...
    protected void rg_simulation_output_ItemDataBound(object sender, GridItemEventArgs e)
    {
        EnergyPlusClient obj_energy_plus_client = new EnergyPlusClient();
        EnergyPlusModel obj_energy_plus_model = new EnergyPlusModel();
        if (e.Item is GridGroupHeaderItem)
    ...
    protected void cmb_simulation_output_type_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
    {
        try
        {
            BindEnergyModelingSimulationOutputGrid();
    ...
    protected void rg_simulation_output_ItemCreated(object sender, GridItemEventArgs e)
    {
    ...
    protected void GetSelectedRows()
    {
        try
        {
            ...
            foreach (GridGroupHeaderItem item in rg_simulation_output.MasterTableView.GetItems(GridItemType.GroupHeader))
            {
    ...
    protected void rg_simulation_output_DataBound(object sender, EventArgs e)
    {
        try
        {
            ReSelectedRows();
