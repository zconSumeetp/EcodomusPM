<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EnergyModelingSimulation.ascx.cs" Inherits="App_UserControls_UserControlNewUI_EnergyModelingSimulation" %>
...
<telerik:RadFormDecorator ID="rdfTaskEquipment" runat="server" Skin="Default" DecoratedControls="Buttons,RadioButtons,Scrollbars" />
 <script type="text/javascript">
     ...
     function CheckSimulationProfile() {
         alert("Please select project!");
         var url = "EnergyModelingProjects.aspx";
     ...
     $(document).ready(function () {
         ...
         $("#div_contentPlaceHolder").scroll(function () {
             $("#ctl00_ContentPlaceHolder1_comparision1_txtradnumeriktextbox_wrapper,#ctl00_ContentPlaceHolder1_comparision1_RadNumericTextBox1_wrapper,#ctl00_ContentPlaceHolder1_comparision1_RadNumericTextBox2_wrapper,#ctl00_ContentPlaceHolder1_comparision1_RadNumericTextBox3_wrapper,#ctl00_ContentPlaceHolder1_comparision1_RadNumericTextBox4_wrapper").removeClass('riSingle riContSpinButtons riButtonSwap RadInput RadInput_Default');
             $("#ctl00_ContentPlaceHolder1_comparision1_txtradnumeriktextbox_wrapper,#ctl00_ContentPlaceHolder1_comparision1_RadNumericTextBox1_wrapper,#ctl00_ContentPlaceHolder1_comparision1_RadNumericTextBox2_wrapper,#ctl00_ContentPlaceHolder1_comparision1_RadNumericTextBox3_wrapper,#ctl00_ContentPlaceHolder1_comparision1_RadNumericTextBox4_wrapper").addClass('riSingle riContSpinButtons riButtonSwap RadInput RadInput_Default');
         });
     });
    </script>
    <style type="text/css">
            ...
            <table border="2" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;
                ...
                <tr>
                    <td style="padding-left: 15px; padding-top: 15px; padding-right: 15px; padding-bottom: 0px;
                        border-color: transparent; border-width: 0px">
                        <asp:UpdatePanel ID="up_simulation_parameter" runat="server" UpdateMode="Conditional">
                            <Triggers>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 75%">
                                                                    ...
                                                                    <telerik:RadProgressArea ID="RadProgressArea1" runat="server" Height="99px" ProgressIndicators="TotalProgressBar"
                                                                        Localization-TotalFiles="1" BorderStyle="None" BorderWidth="0px" Skin="Windows7"
                                                                        EnableAjaxSkinRendering="false" Width="340px" 
                                                                        EnableTheming="True" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right">
                                                                    <telerik:RadNumericTextBox ID="txtradnumeriktextbox" runat="server" ShowSpinButtons="true"  
                                                                        Label="Every" CssClass="normalLabel" Type="Number" DataType="intger" MinValue="0" Skin="Default" 
...
<asp:Timer ID="Timer1" Interval="15000" OnTick="Timer1_click" runat="server"></asp:Timer>
