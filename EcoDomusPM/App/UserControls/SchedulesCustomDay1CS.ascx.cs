...
public partial class App_UserControls_SchedulesCustomDay1CS : System.Web.UI.UserControl
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (custom_day_1 != null)
                {
                    custom_day_1.Value = "chkCustomDay1";
                }
    ...
    private void Update_Flag_For_Schedules(EnergyPlusModel obj_energy_plus_model)
    {
        ...
        try
        {
            ...
            obj_energy_plus_model.Col_name = "custom_day_1";
