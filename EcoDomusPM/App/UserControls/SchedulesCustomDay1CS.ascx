<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SchedulesCustomDay1CS.ascx.cs" Inherits="App_UserControls_SchedulesCustomDay1CS" %>
                    ...
                    <tr>
                        ...
                        <td valign="top">
                            <table border="0" align="left">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkWeekDays" runat="server" Text="Week Days" TextAlign="Right" CssClass="LabelText" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkAllDays" runat="server" Text="All Days" TextAlign="Right" CssClass="LabelText" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkAllOtherDays" runat="server" Text="All Other Days" TextAlign="Right" CssClass="LabelText"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkWinterDesignDay" runat="server" Text="Winter Design Day" TextAlign="Right" CssClass="LabelText"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkSummerDesignDays" runat="server" Text="Summer Design Days" TextAlign="Right" CssClass="LabelText" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkCustomDay1" runat="server" Text="Custom Day1" TextAlign="Right" CssClass="LabelText"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkCustomDay2" runat="server" Text="Custom Day2" TextAlign="Right" CssClass="LabelText"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkWeekEnds" runat="server" Text="Week Ends" TextAlign="Right" CssClass="LabelText"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkHoliday" runat="server" Text="Holiday" TextAlign="Right" CssClass="LabelText"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
