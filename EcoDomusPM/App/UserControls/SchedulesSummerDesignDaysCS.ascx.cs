...
public partial class App_UserControls_SchedulesSummerDesignDaysCS : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            chkSummerDesignDays.Enabled = false;
            UncheckCheckBoxes();
            DisableCheckBoxes();
                    ...
                    if (rcbScheduleName != null)
                    {
                        ...
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                            {
                                ...
                                if (tab_name.Equals("SummerDesignDays"))
                                {
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (Page.IsValid)
            {
                ...
                if (summer_design_day != null)
                {
                    summer_design_day.Value = "chkSummerDesignDays";
                }
    ...
    private void Update_Flag_For_Schedules(EnergyPlusModel obj_energy_plus_model)
    {
        try
        {
            ...
            obj_energy_plus_model.Col_name = "summer_design_days";
