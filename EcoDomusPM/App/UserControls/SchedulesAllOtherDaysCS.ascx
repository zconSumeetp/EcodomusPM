<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SchedulesAllOtherDaysCS.ascx.cs" Inherits="App_UserControls_SchedulesAllOtherDaysCS" %>
                    ...
                    Display="Dynamic" Visible="true" SetFocusOnError="true">
                        ...
                        <tr>
                            <td colspan="3" align="center">
                                <asp:Label ID="lblMsg" ForeColor="Red" runat="server" Text="" Width="100%" CssClass="LabelText"></asp:Label>
                            </td>
                            <td align="right">
