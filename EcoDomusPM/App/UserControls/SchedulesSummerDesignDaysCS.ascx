<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SchedulesSummerDesignDaysCS.ascx.cs" Inherits="App_UserControls_SchedulesSummerDesignDaysCS" %>
...
//                var regex = /^(1[0-2]|[1-9])\/(3[01]|[12][0-9]|[1-9])$/;
    ...
    <telerik:RadFormDecorator ID="rdfSchedules" runat="server" Skin="Default" DecoratedControls="Buttons,RadioButtons,Scrollbars" />
    <fieldset runat="server" id="id1" visible="true" style="border-color: #F9EAEA; border-style: inherit;
    float: inherit; table-layout: auto">
                        ...
                        <td valign="top">
                            <table border="0" align="left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtThrough" runat="server" CssClass="SmallTextBox" Width="100px" Text="01/01"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td colspan="4" align="center">
                                        <asp:Label ID="lblDateErrMsg" runat="server" Text="" ForeColor="Red" CssClass="normalLabel"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkWeekDays" runat="server" Text="Week Days" TextAlign="Right" CssClass="normalLabel"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                ...
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkAllOtherDays" runat="server" Text="All Other Days" TextAlign="Right" CssClass="normalLabel"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkWinterDesignDay" runat="server" Text="Winter Design Day" TextAlign="Right" CssClass="normalLabel"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkSummerDesignDays" runat="server" Text="Summer Design Days" TextAlign="Right" CssClass="normalLabel"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkCustomDay1" runat="server" Text="Custom Day1" TextAlign="Right" CssClass="normalLabel"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkCustomDay2" runat="server" Text="Custom Day2" TextAlign="Right" CssClass="normalLabel"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:CheckBox ID="chkWeekEnds" runat="server" Text="Week Ends" TextAlign="Right" CssClass="normalLabel"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                    ...
                    <table border="0" width="80%" align="left">
                        <tr>
                            ...
                            <td align="left" style="width: 20%;">
                                <asp:Label ID="lblTime" runat="server" Text="Time" CssClass="normalLabel" Font-Underline="true"></asp:Label>
                            </td>
                            <td>
                            </td>
                            <td align="left" style="width: 20%;">
                                <asp:Label ID="lblLimitValue" runat="server" Text="Limit Value" CssClass="normalLabel"
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="txtMonTime" runat="server" CssClass="SmallTextBox" Width="100px"
                                    CausesValidation="true" Text="00:00"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <%--<asp:Button ID="btnSave" runat="server" OnClick="btnSave_Click" Text="Save" Width="50px"
                                    ...
                                    <telerik:RadButton runat="server" ID="btnSave" OnClick="btnSave_Click" Text="Save" OnClientClicked="ValidateFields" AutoPostBack="false"></telerik:RadButton>
