<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UCUniclass.ascx.cs" Inherits="App_Locations_UCUniclass" %>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function select_Sub_System1(id, name) {
                ...
                if (window.parent.location.href.indexOf('TypeProfile') > 0) {
                    window.parent.refreshuniclasslable(name,id);
                    rdw.close();
                }
                else {
                ...
                <tr align="center">
                    <td>
                        <%--<fieldset style="border-style: solid; margin: 0px; border-left-color: #DCDCDC; border-top-color: #DCDCDC;
                            ...
                            <telerik:RadGrid ID="rg_uniclass" runat="server" AllowPaging="True" AutoGenerateColumns="false" Width="100%"
                                ...
                                <MasterTableView ClientDataKeyNames="CategoryID,Category" DataKeyNames="CategoryID,Category">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn DataField="Category" SortExpression="Category" HeaderText="<%$Resources:Resource, Category%>">
                                            ...
                                            <ItemStyle CssClass="column" Width="80%" HorizontalAlign="Left" />
                                        </telerik:GridBoundColumn>
                                    </Columns>
                                </MasterTableView>
                            </telerik:RadGrid>
