...
public partial class App_Asset_DocumentAttributes : System.Web.UI.Page
{
    Guid EntityDataId;
    string EntityName = "";
    ...
    {
        //EntityDataId = new Guid("A7EE2FC0-74C7-4EF6-B3E9-229D9358FA40"); // new Guid(Request.QueryString["entity_id"].ToString());

        EntityDataId = new Guid(Convert.ToString(Request.QueryString["DocumentId"]));
        hf_entity_data_id.Value = EntityDataId.ToString();
        EntityName = "document";//Request.QueryString["entity_name"].ToString();
    ...
    protected void LoadBASServers()
    {
        try
        {
            BASClient basclient = new BASClient();
            BASmodel basmodel = new BASmodel();
            ...
            // radcmbbasserver.DataSource = ds;
            // radcmbbasserver.DataBind();
    ...
    protected void LoadRecordTypes()
    {
        try
        {
            BASClient basclient = new BASClient();
            ...
            DataSet ds = basclient.GetRecordType(basmodel, SessionController.ConnectionString);

            //radcmdrecordingtype.DataSource = ds;
            //radcmdrecordingtype.DataBind();
    ...
    protected void rgAttributes_OnPageSizeChanged(object source, Telerik.Web.UI.GridPageSizeChangedEventArgs e)
    {
        try
        {
    ...
    protected void rgAttributes_OnItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        if (e.CommandName == "Versioning")
        {
            ...
            AttributeModel mdl = new AttributeModel();
            AttributeClient ctrl = new AttributeClient();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "openpopup", "openpopupVersioning('" + attribute_id + "')", true);
        }
    ...
    protected void rgAttributes_OnItemDataBound(object source, GridItemEventArgs e)
    {
        try
        {
            ...
            if (e.Item is GridEditFormItem && e.Item.IsInEditMode)
            {
                ...
                //RadComboBox cmb_bas_server = e.Item.FindControl("cmb_bas_server") as RadComboBox;
                //RadComboBox cmb_recording_type = e.Item.FindControl("cmb_recording_type") as RadComboBox;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            if (SessionController.ConnectionString.ToString() != "")
            {
                ...
                //mdl.Attribute_created_on=DateTime.Now.ToString();
                mdl.Attribute_created_on = DateTime.Now;
