...
public partial class App_Asset_Schedules : System.Web.UI.Page
{
    ...
    private void Bind_Type_Name_DropDown()
    {
        ...
        try
        {
            ...
            rcbTypeName.DataTextField = "object_name";
            rcbTypeName.DataValueField = "object_name";
    ...
    protected void btnDeleteSchedule_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            obj_energy_plus_model.Name = rcbScheduleName.Text;
    ...
    protected void rcbScheduleName_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
    {
        ...
        try
        {
            string scheduleName = rcbScheduleName.SelectedValue.ToString();
