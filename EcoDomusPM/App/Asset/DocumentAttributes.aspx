<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DocumentAttributes.aspx.cs"
    Inherits="App_Asset_DocumentAttributes" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript" language="javascript">
            ...
            function openpopupVersioning(attributeid) {
                ...
                var url;
                url = "../Asset/AttributeVersioningPopup.aspx?attribute_id=" + attributeid + "&attribute_flag=Document";
            ...
            //                    var delete_attribute = confirm("Delete the selected attributes for component in this project?");
            //                    if (delete_attribute) {
            ...
            function deleteAttributes() {
                ...
                if (s == "") {
                    ...
                    if (entityname == "Asset") {
                        var url = "../Asset/DeleteAttribute.aspx?attribute_id=" + itemtodelete.toString() + "&flag=component" + "&EntityDataId=" + document.getElementById("<%=hf_entity_data_id.ClientID%>").value + "&EntityName=" + document.getElementById("<%=hf_entity_name.ClientID%>").value;
                    }
                    else if (entityname == "System") {
                        var url = "../Asset/DeleteAttribute.aspx?attribute_id=" + itemtodelete.toString() + "&flag=system" + "&EntityDataId=" + document.getElementById("<%=hf_entity_data_id.ClientID%>").value + "&EntityName=" + document.getElementById("<%=hf_entity_name.ClientID%>").value;
                    }
                    if (manager != null) {
                        var windows = manager.get_windows();
                        windows[0].setUrl(url);
...
<body style="background:transparent;background-image:url('../Images/asset_zebra-bkgrd_gray2.PNG');margin:0px; padding:0px;">
    ...
    <table border="0" width="100%" style="margin: 0px 0px 0px 0px;padding:0px; ">
        ...
        <tr>
            <td class="centerAlign" style=" padding-top: 0px;">
                <%--<asp:Panel ID="panelSearch25"  runat="server" DefaultButton="btnSearch">--%>
                        ...
                        <tr>
                            <td align="left" class="entityImage" style="width: 50%;">
                                <asp:Label runat="server" ID="lbl_grid_head" CssClass="gridHeadText" Width="200px"
                                    Text="Attributes" ForeColor="#F8F8F8" Font-Names="Arial" Font-Size="12"></asp:Label>
                            </td>
                ...
                <div id="divSelectedDomponentContent" >
                        <telerik:RadGrid ID="rgAttributes" runat="server" BorderWidth="1px" CellPadding="0"
                            GridLines="None" AllowPaging="true" OnPageIndexChanged="rgAttributes_OnPageIndexChanged"
                              OnPageSizeChanged="rgAttributes_OnPageSizeChanged" OnSortCommand="rgAttributes_OnSortCommand"
                            ...
                            OnPreRender="rgAttributes_OnPreRender" 
                            onitemcreated="rgAttributes_ItemCreated">
                            ...
                            <MasterTableView EditMode="EditForms" DataKeyNames="attribute_id,attribute_unit"
                                ...
                                <%--<asp:LinkButton ID="LinkButton1" runat="server"  CommandName="Delete" Text="Delete Attribute"  >
                ...
                <div id="div1" style="display: none;">
                    <asp:Button ID="Button1" runat="server" Style="display: none;" OnClick="btn_refresh_Click" />
                </div>
                <%--  </asp:Panel>--%>
            </td>
        </tr>
        ...
        <tr id="trAddAttribute" runat="server" style="display: none;">
            <td>
                <table>
                <tr id="trbtnAddAttribute" runat="server" style="display: none;">
            <td>
                <asp:Button ID="btnAddAttribute" runat="server" Text="<%$Resources:Resource,Add_Attribute%>"
                    CausesValidation="false" Width="150px" OnClientClick="javascript:return AddAttribute();" />
                 <asp:Panel ID="aspPanel" runat="server">                    
                    ...
                    Width="100px" OnClientClick="javascript:return deleteAttributes();" 
                        />
                </asp:Panel>
            </td>
            <td>
                    ...
                    <tr>
                        <td>
                            <table border="0">
                                ...
                                <tr>
                                    <th style="width: 100px" align="left" valign="top">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox ID="cmbStage" MarkFirstMatch="true" runat="server" Width="185px"
                                            TabIndex="4">
                                        </telerik:RadComboBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox ID="cmbGroup_outer" MarkFirstMatch="true" runat="server" Width="185px"
                                            TabIndex="5">
                                        </telerik:RadComboBox>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Button ID="btnSave" runat="server" TabIndex="7" Text="<%$Resources:Resource,Save%>"
                                            Width="100px" OnClick="btnSave_Click" ValidationGroup="RequiredField" />
                                        <asp:Button ID="btnCancel" runat="server" TabIndex="8" Text="<%$Resources:Resource,Cancel%>"
                                            Width="100px" OnClientClick="javascript:return CancelAddAttribute();" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td valign="top" id="tdbasinfo" runat="server">
                            <%-- <asp:CheckBox OnCheckedChanged="chkmap_changed" AutoPostBack="true" ID="chkmap" runat="server" />
                            Map Attribute To Building Automation System
                            <table id="tblbasinfor" runat="server" visible="false">
                                <tr>
                                    <td colspan="2">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox  ID="radcmbbasserver"  Width="250px" runat="server" EmptyMessage="Select" DataTextField="servername" DataValueField="pk_bas_server_id" >
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadComboBox Width="250px" EmptyMessage="Select" ID="radcmdrecordingtype" DataValueField="pk_recording_type_id" DataTextField="name" runat="server">
                                        </telerik:RadComboBox>
                                    </td>
                                </tr>
                                <tr>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" EnableAJAX="true">
        <AjaxSettings>
            ...
            <%--  <telerik:AjaxSetting AjaxControlID="chkmap">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="tblbasinfor" LoadingPanelID="loadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            --%>
            <telerik:AjaxSetting AjaxControlID="imgbtnHistory">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgAttributes" LoadingPanelID="loadingPanel1" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server" Skin="Default" AutoSize="false">
        <Windows>
            <telerik:RadWindow ID="RadWindow1" runat="server" Animation="None" Title="EcoDomus PM:Delete Attributes"
                Behaviors="Move" ReloadOnShow="True" Width="550" Height="145" VisibleStatusbar="false"
                VisibleOnPageLoad="false" Top="200%" Left="250%" EnableAjaxSkinRendering="false"
                BorderStyle="None" BackColor="Red" VisibleTitlebar="false" AutoSize="false" Overlay="false">
            </telerik:RadWindow>
        </Windows>
    </telerik:RadWindowManager>
    </form>
