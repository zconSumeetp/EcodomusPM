<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IssuePDFs.aspx.cs" Inherits="App_Asset_IssuePDF" %>
                        ...
                        <telerik:RadGrid ID="rgIssue" runat="server" BorderWidth="1px" CellPadding="0" Width="107%"
                            ...
                            <MasterTableView DataKeyNames="pk_issues_id">
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn DataField="typename" HeaderText="<%$Resources:Resource,Type%>" SortExpression="typename">
                                        <ItemStyle CssClass="column" Width="300px" />
                                        <HeaderStyle HorizontalAlign="Left" Height="60" />
                                    </telerik:GridBoundColumn>
                                    <telerik:GridBoundColumn DataField="organizationusername" UniqueName="Owner" HeaderText="<%$Resources:Resource,Assigned_To%>"
                                    ...
                                    <telerik:GridBoundColumn DataField="issuestatus" HeaderText="<%$Resources:Resource,Issue_Status%>">
                                        <ItemStyle CssClass="column" Width="300px" />
                                        <HeaderStyle HorizontalAlign="Left" Height="60" />
                                    </telerik:GridBoundColumn>
                                </Columns>
